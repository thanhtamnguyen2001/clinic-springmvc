<%-- 
    Document   : doctor_header
    Created on : Aug 8, 2022, 3:58:11 PM
    Author     : Thanh_Tam
--%>
        ...
        <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                        <ul class="navbar-nav me-auto">
                                <li class="nav-item">
                                        <a class="nav-link" href="<c:url value="/nurse/registration-list" />">DANH SÁCH BỆNH NHÂN KHÁM BỆNH</a>
                                </li>
                                <li class="nav-item">
                                        <a class="nav-link" href="<c:url value="/nurse/payment" />"></a>
                                </li>
                                <li class="nav-item">
                                        <a class="nav-link" href="<c:url value="/nurse/medical-registry" />"></a>
                                </li>
                                <li class="nav-item">
